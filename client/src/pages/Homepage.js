...
const handleQuantityChange = (productId, newQuantity) => {
  ...
  allproducts.map((p) => {
    ...
    return (
      ...
      >
        <button
          onDoubleClick={() => navigate(`/singleProduct/${p.slug}`)}
          className="text-dark"
          ...
          >
            ...
            <div className="px-5 pb-5">
              ...
              <form className="max-w-xs mx-auto">
                <div className="relative flex items-center max-w-[8rem]">
                  <button
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      handleQuantityChange(p._id, Math.max(1, productQuantity - 1));
                    }}
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      e.preventDefault();
                      handleQuantityChange(p._id, parseInt(e.target.value, 10) || 1);
                    }}
                    required
                  />
                  <button
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      handleQuantityChange(p._id, productQuantity + 1);
                    }}
                  >
                    <svg
                      className="w-3 h-3 text-gray-900 dark:text-white"
              ...
              <button
                ...
                onClick={() => {
                  if (auth?.token) {
                    setCart([...cart, { ...p, quantity: productQuantity }]);
                  } else {
